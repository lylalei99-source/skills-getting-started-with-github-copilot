...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 18,
        "participants": ["jake@mergington.edu", "lauren@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Society": {
        ...
        "max_participants": 20,
        "participants": ["eva@mergington.edu", "matt@mergington.edu"]
    },
    "Debate Team": {
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate activity has room for more participants
